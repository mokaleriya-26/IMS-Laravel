                    ...
                    <div id="student-section" class="border-t pt-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div>
                                ...
                                <select id="year_of_study" name="year_of_study" class="w-full h-12 bg-slate-50 border border-slate-200 rounded-xl px-4 text-sm font-bold text-slate-700 focus:outline-none focus:border-[#005F5B] focus:bg-white transition-all">
